import { action, atom, reatomResource, sleep, withCache, withDataAtom, withErrorAtom } from "@reatom/framework";
...
}, "historicalRatesAtom").pipe(withDataAtom([]), withCache({ length: 10, swr: false }), withErrorAtom());
